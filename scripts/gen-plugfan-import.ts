 ...
 * TAG_FACTORS["CPF"] is ×1 (so body price = CEB). It has NO outlet area/velocity
 * (no housing). Selection is by volume flow + static pressure only:
 *   • Belt drive  — the fan is sized so the required speed stays ≤ 1600 rpm.
 *   • Direct drive — standard 2/4/6-pole bands (same as HPB) via the selector's
 *     directDrive flag.
 * The vibration-isolator recommendation is the standard Centrifugal-Type set.
 *
