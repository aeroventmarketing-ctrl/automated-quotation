 ...
 * receipt). Rendered as a grid cell so it sits on the same row as the other count
 * tiles; clicking it expands the full list full-width below the row (col-span-full).
 * Each row shows the PO number, supplier, amount, and who recorded it (name,
 * designation, date & time), and opens the PO document.
 */
