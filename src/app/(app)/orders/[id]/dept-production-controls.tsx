...
export function DeptProductionControls({
  ...
  proofs: JobProof[];
  canAddProofs: boolean;
  canRemoveProofs: boolean;
}) {
  ...
  return (
    <div className="mb-2">
      ...
      {status != null && (
        <JobOrderProofs orderId={orderId} deptKey={deptKey} initialProofs={proofs} canAdd={canAddProofs} canRemove={canRemoveProofs} />
      )}
