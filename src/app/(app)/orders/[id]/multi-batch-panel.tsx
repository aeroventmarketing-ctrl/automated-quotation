          ...
          {(podFiles.length > 0 || canManagePod) && (
            <div className="mt-2 rounded-md border bg-muted/20 p-2">
              ...
              {deliverBlocked && canManagePod && (
                <p className="mt-1 text-[11px] text-muted-foreground">{officePickup ? "Attach at least one proof of pick up to enable “Mark picked up”." : "Attach at least one proof of delivery to enable “Mark delivered”."}</p>
              )}
            </div>
          )}
