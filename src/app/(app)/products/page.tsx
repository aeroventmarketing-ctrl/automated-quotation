...
const VIEW_ROLES: WorkflowRoleKey[] = ["purchaser", "warehouse", "plant_manager", "payment_approver", "accounting", "logistics", "prod_head_duct", "prod_head_accessories", "prod_head_motor"];
