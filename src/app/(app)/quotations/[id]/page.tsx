    ...
    <QuotationBuilder
      ...
      quotation={{
        ...
        classification: {
          ...
          shape: (quotation.classification as Record<string, string>)?.shape ?? "",
          sizeL: (quotation.classification as Record<string, string>)?.sizeL ?? "",
          sizeW: (quotation.classification as Record<string, string>)?.sizeW ?? "",
        },
