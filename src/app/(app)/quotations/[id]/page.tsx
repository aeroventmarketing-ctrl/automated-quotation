  ...
  return (
    <div className="space-y-4">
      ...
      quotation={{
        ...
        inquiryStatus: quotation.inquiry.status,
        ...
        items: quotation.items.map((it) => {
          ...
          return {
            ...
            specs: {
              ...
              insectScreen: s.insectScreen === true,
              ...
              ductCalcOffset: typeof s.ductCalcOffset === "string" ? s.ductCalcOffset : "",
              ...
              paintType:
                s.paintType === "Powder Coat Paint"
                  ? "Powder Coated Finish"
                  : typeof s.paintType === "string"
                  ? s.paintType
                  : "",
            },
