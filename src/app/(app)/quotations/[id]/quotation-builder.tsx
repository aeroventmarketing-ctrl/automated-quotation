 ...
 *  (2R + B)(R + B)·2 + 1.5708·R·A·2 + 1.5708·(B + R)·2·A. Needs A, B and R all set.
...
export function QuotationBuilder({
  ...
  // Gross (VAT-inclusive) line total = quantity × unit price, for every product
  // (the Duct Angle corner included, so 500 × ₱8 reads as exactly ₱4,000 rather
    ...
    return (
      <div className="space-y-1">
        ...
        <div className={`grid grid-cols-2 gap-2 ${selCols}`}>
          ...
          {/* Double Wall — Cabinet Type only; ×1.46 on the body + blade (incl. the
