...
PH SALES-INVOICE BOOKLET — "SALES INVOICE" or "CHARGE SALES INVOICE", handwritten OR pre-printed (a padded form the supplier fills in — e.g. WINGS COMMERCIAL (handwritten), GOLDEN PACIFIC INC., TKL STEEL CORPORATION, ALLOYMASTER INDUSTRIAL SUPPLY, IDEAL CONTROLS INC., INTERNATIONAL SPRING INDUSTRIES, JSL ELECTRIC CORPORATION, and any dealer/hardware/industrial-supply sales-invoice booklet with a "SALES INVOICE"/"CHARGE SALES INVOICE" header, a "Sold to"/"Registered Name" block, and a body table whose columns are QUANTITY | (UNIT/UOM) | ARTICLES/ITEM DESCRIPTION | UNIT PRICE | AMOUNT). Whether the entries are handwritten or typed, the figures on a SUPPLIER sales invoice ARE the official values — READ THEM (unlike bank deposit slips). Rules:
  • INVOICE NUMBER: the pre-printed serial next to "No." / "Invoice No." at the TOP-RIGHT (a 4–8 digit serial, usually RED — e.g. "47019", "16443", "954314", "11790", "35817", or with leading zeros like "0001877"). Read it exactly as printed, KEEPING any leading zeros (digits only, drop the leading "No."), into "invoiceNumber".
  • DATE: the "DATE:" near the top — handwritten/typed as M/D/YY or D-M-YY (e.g. "8/12/26" or "4-17-26" = 17 Apr 2026), or written in full (e.g. "May 13, 2026", "12-Aug-26"). Report it in "date" as written. (Ignore the tiny pre-printed "Date Issued" / BIR "Date Issued" at the very bottom of the form — that's the booklet's printing date, not the sale date.)
