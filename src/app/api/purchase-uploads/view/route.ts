...
/**
 * View a stored purchasing document (reconciliation receipt, return proof, …) in
 * the browser without downloading — the "eye" view. Spreadsheets render to an
 * HTML preview; PDFs and images show inline via a short-lived signed URL. Add
 * ?download=1 to force a download. Internal-only and scoped to purchases/.
 */
