...
import { LayoutDashboard, Inbox, FileText, BellRing, ClipboardList, Boxes, Package, ShoppingCart, Percent, Gauge, Wrench, Settings, LogOut, UserCog } from "lucide-react";
