...
const SEG_FIELDS: SegField[] = [
  ...
  { key: "payeeTin", y: 1757952, cy: 216193, sz: 1000, nudge: 86766, centers: TIN_CENTERS }, // +½ column right
  { key: "payorTin", y: 3401328, cy: 227267, sz: 1000, nudge: 86766, centers: TIN_CENTERS }, // +½ column right
