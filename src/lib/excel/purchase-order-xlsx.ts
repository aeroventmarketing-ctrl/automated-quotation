...
// Last group (branch code) individually tuned: 1st 0 +¼ col, 2nd 0 −¼ col, 3rd 0 as-is.
const TIN_CENTERS = [2594777, 2768308, 2941839, 3274577, 3448108, 3621639, 3950414, 4123945, 4297476, 4657817, 4895389, 5263110];
