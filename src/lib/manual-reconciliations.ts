 ...
 * reconciliation whose discrepancy has already been approved (by the Payment
 * Approver or an Admin) is also excluded (it's been handled). Each row keeps who
 * recorded it, their designation, and the date/time.
 */
