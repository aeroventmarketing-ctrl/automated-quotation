...
export interface Reconciliation {
  ...
  // Whether the recorded actuals were read from the uploaded receipt by the AI
  // (true) or typed in by hand (false/undefined). A manual record only proves the
  // typed figures tally against the PO — NOT that they match the uploaded receipt.
  aiVerified?: boolean;
  note?: string;
