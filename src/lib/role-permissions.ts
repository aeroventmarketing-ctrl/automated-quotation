...
export const DEFAULT_ROLE_CAPS: Record<string, string[]> = {
  ...
  technical_head: ["restrict_client_data", "view_orders", "create_job_orders", "approve_job_orders", "add_schedule"],
  ...
  prod_head_motor: ["restrict_client_data", "view_orders", "create_job_orders", "approve_job_orders", "start_production", "finish_production", "raise_requisition", "confirm_transfer_prodhead", "add_schedule"],
