...
export const config = {
  ...
  matcher: ["/((?!_next/static|_next/image|favicon.ico|icons|aerovent-logo.jpg|login-bg.jpg|straight-duct.png|duct-connector.jpg|reducer.jpg|manifest.webmanifest|sw.js).*)"],
};
